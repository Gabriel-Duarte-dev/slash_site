...
export const Footer = () => {
  ...
  return (
    <footer className="w-screen min-h-[12.5rem] flex items-center justify-center bg-purple-500 relative">
      <div className="flex justify-center items-center sm:gap-3 md:gap-10">
      ...
      <p className="text-white text-center font-light sm:text-[10px] md:text-[0.75rem] absolute bottom-0 left-1/2 -translate-x-2/4">
